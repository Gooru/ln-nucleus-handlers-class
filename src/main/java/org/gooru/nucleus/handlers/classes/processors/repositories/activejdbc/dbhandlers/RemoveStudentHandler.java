...
class RemoveStudentHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    try {
      AJClassMember.delete(AJClassMember.REMOVE_STUDENT_QUERY_FILTER, context.classId(),
          context.studentId());
      return new ExecutionResult<>(
          MessageResponseFactory
              .createNoContentResponse(RESOURCE_BUNDLE.getString("student.removed"),
                  EventBuilderFactory
                      .getStudentRemovalEventBuilder(context.classId(), context.studentId())),
