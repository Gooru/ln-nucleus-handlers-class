 ...
 */
public class ClassSecondaryClassesFindProcessor extends AbstractCommandProcessor {

  protected ClassSecondaryClassesFindProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildClassRepo(context).findSecondaryClasses();
  }
