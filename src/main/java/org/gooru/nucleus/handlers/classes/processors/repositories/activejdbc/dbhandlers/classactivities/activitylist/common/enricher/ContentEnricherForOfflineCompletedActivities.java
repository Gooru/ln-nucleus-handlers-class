...
class ContentEnricherForOfflineCompletedActivities implements ContentEnricher {
  ...
  ContentEnricherForOfflineCompletedActivities(List<AJEntityClassContents> classContents,
      boolean isStudent) {
