...
public class AJEntityClassContents extends Model {
  ...
  public static final Set<String> CREATABLE_FIELDS = new HashSet<>(Arrays
      .asList(ID, CLASS_ID, CTX_COURSE_ID, CTX_UNIT_ID, CTX_LESSON_ID, CTX_COLLECTION_ID,
  ...
  public static final List<String> RESPONSE_FIELDS = Arrays
      .asList(ID, CONTENT_ID, CONTENT_TYPE, CTX_COURSE_ID, CTX_UNIT_ID, CTX_LESSON_ID,
          CTX_COLLECTION_ID,
  ...
  private static Map<String, FieldConverter> initializeConverters() {
    ...
    converterMap
        .put(CTX_COURSE_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap
        .put(CTX_UNIT_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap
        .put(CTX_LESSON_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap.put(CTX_COLLECTION_ID,
  ...
  private static Map<String, FieldValidator> initializeValidators() {
    ...
    validatorMap
        .put(CTX_COURSE_ID, (value -> FieldValidator.validateUuidIfPresent((String) value)));
    validatorMap.put(CTX_UNIT_ID, (value -> FieldValidator.validateUuidIfPresent((String) value)));
    validatorMap
        .put(CTX_LESSON_ID, (value -> FieldValidator.validateUuidIfPresent((String) value)));
    validatorMap
        .put(CTX_COLLECTION_ID, (value -> FieldValidator.validateUuidIfPresent((String) value)));
    validatorMap
        .put(CONTENT_TYPE,
    ...
    validatorMap.put(DCA_ADDED_DATE, (value -> FieldValidator
        .validateDateWithFormatWithInDaysBoundary(value, DateTimeFormatter.ISO_LOCAL_DATE, 1,
            AppConfiguration.getInstance().getDateRangeToInterval())));
  ...
  public void setDefaultActivationDateIfNotPresent() {
    if (this.getDate(ACTIVATION_DATE) == null) {
      this.set(ACTIVATION_DATE,
          FieldConverter
              .convertFieldToDateWithFormat(LocalDate.now(), DateTimeFormatter.ISO_LOCAL_DATE));
    }
  }
