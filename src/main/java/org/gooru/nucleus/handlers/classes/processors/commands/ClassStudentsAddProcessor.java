 ...
 */
public class ClassStudentsAddProcessor extends AbstractCommandProcessor {

  protected ClassStudentsAddProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildClassRepo(context).addStudentsToClass();
  }
