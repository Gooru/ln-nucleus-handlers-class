...
class ClassProfileBaselineTriggerProcessor extends AbstractCommandProcessor {

  ClassProfileBaselineTriggerProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildClassRepo(context).updateProfileBaselineForSpecifiedStudents();
  }
