...
class ClassUpdateRescopeSettingProcessor extends AbstractCommandProcessor {
    public ClassUpdateRescopeSettingProcessor(ProcessorContext context) {
        super(context);
    }
    ...
    protected MessageResponse processCommand() {
        ...
        return RepoBuilder.buildClassRepo(context).updateRescopeClassSetting();
    }
}
