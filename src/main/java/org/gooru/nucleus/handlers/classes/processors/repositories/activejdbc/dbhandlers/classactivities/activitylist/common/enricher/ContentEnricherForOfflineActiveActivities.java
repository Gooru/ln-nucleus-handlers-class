...
class ContentEnricherForOfflineActiveActivities implements ContentEnricher {
  ...
  ContentEnricherForOfflineActiveActivities(List<AJEntityClassContents> classContents,
      boolean isStudent) {
