...
public class ClassMembersActivateHandler implements DBHandler {

  private static final Logger LOGGER = LoggerFactory.getLogger(ClassMembersActivateHandler.class);
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private final ProcessorContext context;
  private ClassMembersActivateCommand command;
  private AJEntityClass entityClass;

  public ClassMembersActivateHandler(ProcessorContext context) {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    try {
      command = ClassMembersActivateCommand.build(context);
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    try {
      ...
      return AuthorizerBuilder.buildClassMemberActivateAuthorizer(this.context)
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    try {
      ...
      AJClassMember.markMembersAsActive(context.classId(), command.getUsersList());
