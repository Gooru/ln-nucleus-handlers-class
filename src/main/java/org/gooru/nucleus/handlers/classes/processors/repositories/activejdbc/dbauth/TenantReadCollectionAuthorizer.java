 ...
 */
class TenantReadCollectionAuthorizer implements Authorizer<AJEntityCollection> {

  private final ProcessorContext context;
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private static final Logger LOGGER = LoggerFactory
      .getLogger(TenantReadCollectionAuthorizer.class);

  public TenantReadCollectionAuthorizer(ProcessorContext context) {
