...
class ContentEnricherForUnscheduledActivities implements ContentEnricher {
  ...
  ContentEnricherForUnscheduledActivities(List<AJEntityClassContents> classContents) {
