...
class UpdateCollaboratorForClassHandler implements DBHandler {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(UpdateCollaboratorForClassHandler.class);
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    ...
    if (collaboratorsAreTeachersOrStudents()) {
      return new ExecutionResult<>(
          MessageResponseFactory
              .createForbiddenResponse(RESOURCE_BUNDLE.getString("existing.member")),
          ExecutionResult.ExecutionStatus.FAILED);
    }
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    return new ExecutionResult<>(MessageResponseFactory
        .createNoContentResponse(RESOURCE_BUNDLE.getString("updated"),
            EventBuilderFactory
                .getCollaboratorUpdatedEventBuilder(context.classId(), diffCollaborators)),
  ...
  private boolean collaboratorsAreTeachersOrStudents() {
    ...
    List<String> collaborators = rawCollaborator.stream().map(Object::toString)
        .collect(Collectors.toList());
    Long countOfStudents = AJClassMember
        .count(AJClassMember.STUDENT_COUNT_FROM_SET_FILTER, context.classId(),
