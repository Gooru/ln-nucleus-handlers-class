...
class ClassRerouteSettingsUpdateProcessor extends AbstractCommandProcessor {

  ClassRerouteSettingsUpdateProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildClassRepo(context).updateClassRerouteSetting();
  }
}
