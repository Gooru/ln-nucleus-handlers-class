...
class ClassMembersRerouteSettingsUpdateProcessor extends AbstractCommandProcessor {

  ClassMembersRerouteSettingsUpdateProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildClassRepo(context).updateClassMembersRerouteSetting();
  }
