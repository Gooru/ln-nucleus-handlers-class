 ...
 */
public class TenantReadClassAuthorizer implements Authorizer<AJEntityClass> {

  private final ProcessorContext context;
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private static final Logger LOGGER = LoggerFactory.getLogger(TenantReadClassAuthorizer.class);

  public TenantReadClassAuthorizer(ProcessorContext context) {
